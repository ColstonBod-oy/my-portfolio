...
export const metadata = {
  title: 'Little Prince',
  description: "This is Colston Bod-oy's portfolio site.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang='en' className='!scroll-smooth'>
      <body
        className={`${inter.className} relative bg-gray-50 pt-28 text-gray-950 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 sm:pt-28`}
      >
